...
class _LoginPhoneScreenState extends ConsumerState<LoginPhoneScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Web platform doesn't support phone login
    if (kIsWeb) {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: AppSpacing.s6),
              Text(
                'Đăng nhập bằng SĐT không khả dụng trên Web',
                style: AppTextStyle.title2,
                textAlign: TextAlign.center,
              ),
              const SizedBox(height: AppSpacing.s4),
              Text(
                'Đăng nhập bằng số điện thoại chỉ khả dụng trên ứng dụng mobile (Android).\n\nTrên phiên bản Web, vui lòng sử dụng Email để đăng nhập.',
                textAlign: TextAlign.center,
